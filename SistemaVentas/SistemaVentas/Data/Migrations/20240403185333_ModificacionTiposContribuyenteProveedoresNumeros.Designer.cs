...
namespace SistemaVentas.Migrations
{
    ...
    [Migration("20240403185333_ModificacionTiposContribuyenteProveedoresNumeros")]
    partial class ModificacionTiposContribuyenteProveedoresNumeros
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Models.CuentasPorCobrar", b =>
                {
                    b.Property<int>("CuentaPorCobrarId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CuentaPorCobrarId"));
            ...
            modelBuilder.Entity("Library.Models.CuentasPorCobrarDetalle", b =>
                {
                    b.Property<int>("CuentasPorCobrarDetalleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CuentasPorCobrarDetalleId"));
                    ...
                    b.HasKey("CuentasPorCobrarDetalleId");

                    b.HasIndex("CuentaPorCobrarId");

                    b.ToTable("CuentasPorCobrarDetalle");
                });
            ...
            modelBuilder.Entity("Library.Models.CuentasPorCobrar", b =>
                {
                    b.HasOne("Library.Models.Ventas", "Venta")
                        .WithOne("CuentaPorCobrar")
                        .HasForeignKey("Library.Models.CuentasPorCobrar", "VentaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Library.Models.CuentasPorCobrarDetalle", b =>
                {
                    b.HasOne("Library.Models.CuentasPorCobrar", null)
                        .WithMany("CuentasPorCobrarDetalle")
            ...
            modelBuilder.Entity("Library.Models.CuentasPorCobrar", b =>
                {
                    b.Navigation("CuentasPorCobrarDetalle");
                });
